...
export const ITEM_DEFS = [
  // raw materials
  { id: 100, name: 'stick', type: 'item', stack: 64, color: C.stick },
  { id: 101, name: 'coal', type: 'item', stack: 64, color: C.coal },
  { id: 102, name: 'iron_ingot', type: 'item', stack: 64, color: C.iron_ingot },
  { id: 103, name: 'gold_ingot', type: 'item', stack: 64, color: C.gold_ingot },
  { id: 104, name: 'diamond', type: 'item', stack: 64, color: C.diamond },
  { id: 105, name: 'iron_ore_raw', type: 'item', stack: 64, color: C.iron_ore_raw },
  { id: 106, name: 'gold_ore_raw', type: 'item', stack: 64, color: C.gold_ore_raw },
  { id: 124, name: 'wheat', type: 'item', stack: 64, color: C.wheat },
  // food / water
  { id: 125, name: 'bread', type: 'item', stack: 64, color: C.bread, food: 5 },
  { id: 122, name: 'boat', type: 'item', stack: 1, color: C.boat },
  { id: 123, name: 'bucket', type: 'item', stack: 16, color: C.bucket },
  // tools
...
/** Stable id assignment for tools (110..121). */
function toolIdFor(name) {
  const idx = Object.keys(TOOLS).indexOf(name);
  return 110 + idx;
}
export const TOOL_ID_BASE = 110;
